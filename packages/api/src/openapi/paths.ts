...
function pathsSistema(): OpenApiPaths {
  return {
    ...
    "/api/resumo": pathItem({
      get: op("get", "Sistema", "Dashboard — contagens dos widgets (sem recebimentos)", {
        operationId: "resumo",
      }),
    }),
  };
    ...
    "/api/contratos": pathItem({
      get: op("get", "Contratos", "Listar contratos", {
        ...
        parameters: [
          ...
          refParam("PlacaQuery"),
          query("dataInicial", { type: "string", description: "DD/MM/AAAA" }),
          query("dataFinal", { type: "string", description: "DD/MM/AAAA" }),
        ],
        responses: { "200": { $ref: "#/components/responses/OkList" } },
      }),
    }),
