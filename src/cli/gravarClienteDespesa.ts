...
import { CategoriaDespesaCliente } from "../lib/domain/categoriaDespesaCliente.js";
...
function printResult(
  ...
  const cond =
    m.condutorId != null
      ...
      : "(não identificado)";
  console.log(
    `[OK] ${m.autoInfracao} | ${m.categoria ?? CategoriaDespesaCliente.Infracao} | ${m.veiculoId} | R$ ${m.valorMulta.toFixed(2)} | ${m.dataAutuacao}`,
  );
