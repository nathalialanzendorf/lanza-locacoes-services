...
const dados = {
  ...
  "placa": "IWP-5G63",
  "modeloVeiculo": "RENAULT/SANDERO 1.6 Flex",
  "anoModelo": "2015/2015",
  ...
  "qtdDiasLocado": 29,
  "linhaEncerramento": "Encerrado em 27/06/2026 — Devolvido",
  "valorSemanal": 650,
  "valorDiaria": 120,
  "totalDebitos": 881.49,
  "infracoes": [],
...
export default function CobrancaIwp5g63JulianoFoizerSilveira() {
  const theme = useHostTheme();
