...
const dados = {
  ...
  "resumoSemanal": {
    ...
    "totalReceber": 3007.07,
    "diasAtrasados": 17,
    "diasEmDia": 4,
    "jurosMultaAcumulados": 607.07
  },
  "pagamentoSemanal": {
    "tabelas": [
      {
...
export default function CobrancaJulianoFoizerSilveira() {
  const theme = useHostTheme();
