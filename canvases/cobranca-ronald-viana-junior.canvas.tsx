...
const dados = {
  ...
  "resumoSemanal": {
    ...
    "totalReceber": 1544.26,
    "diasAtrasados": 9,
    "diasEmDia": 3,
    "jurosMultaAcumulados": 244.26
  },
  "pagamentoSemanal": {
    "tabelas": [
      {
...
export default function CobrancaRonaldVianaJunior() {
  const theme = useHostTheme();
