...
const dados = {
  ...
  "parcelasEmAberto": [
    ...
    {
      "descricao": "ATRASADO Pagamento semanal - Sexta 17",
      "placa": "IYR-8F19",
      "data": "17/07/2026",
      "categoria": "Locação semanal",
      "valor": 800
  ...
  "totalParcelasEmAberto": 2372,
  "totalSemanalCobrar": 2372,
  "debitosDiversos": [
    {
  ...
  "resumoSemanal": {
    ...
    "totalReceber": 1049.97,
    "diasAtrasados": 7,
    "diasEmDia": 1,
    "jurosMultaAcumulados": 249.97
  },
  "pagamentoSemanal": {
    "tabelas": [
      {
...
export default function CobrancaLaryssaGustavoCostaDeQuadros() {
  const theme = useHostTheme();
