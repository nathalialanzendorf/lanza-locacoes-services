...
const dados = {
  "cliente": "Rafaela Cardoso Debiazi (Higor)",
  "placa": "PWH-3A45",
  "modeloVeiculo": "FIAT/DOBLO ESSENCE 1.8",
  "anoModelo": "2015/2015",
  "dataInicio": "13/11/2025",
  "dataFim": "11/02/2026",
  "qtdDiasContrato": 90,
  ...
  "debitosDiversos": [
    {
      "descricao": "ATRASADO Pagamento mensal - 15/07",
      "placa": "PWH-3A45",
      "data": "15/07/2026",
      "categoria": "Outros",
      "valor": 2800
  ...
  "mensagensWhatsApp": [
    {
      ...
      "titulo": "📋 Despesas em aberto — PWH-3A45",
      "texto": "📋 *Despesas em aberto* — PWH-3A45\n\nOlá, Rafaela!\nSegue a listagem das despesas referente à locação do seu FIAT/DOBLO ESSENCE 1.8 que segue em aberto:\n\n• PWH-3A45 · 15/07/2026 · ATRASADO Pagamento mensal - 15/07 · R$ 2.800,00\n\n*Total em aberto: R$ 2.800,00*\n\n_Mensagem automática enviada pelo sistema Gerenciador de Locações Veiculares._\n"
    }
  ],
  "avisos": []
} as {
...
export default function CobrancaRafaelaCardosoDebiaziHigor() {
  const theme = useHostTheme();
