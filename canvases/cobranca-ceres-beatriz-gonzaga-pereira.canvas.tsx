...
const dados = {
  ...
  "resumoSemanal": {
    ...
    "dataBloqueioBr": "15/07/2026",
    "totalReceber": 2685.68,
    "diasAtrasados": 12,
    "diasEmDia": 0,
    "jurosMultaAcumulados": 685.68
  },
  "pagamentoSemanal": {
    "tabelas": [
      {
      ...
      {
        "vencimentoBr": "13/07/2026",
        "periodoInicioBr": "13/07/2026",
        "periodoFimBr": "20/07/2026",
        "linhas": [
          {
            "dataBr": "13/07/2026",
            "diaSemana": "Seg",
...
export default function CobrancaCeresBeatrizGonzagaPereira() {
  const theme = useHostTheme();
