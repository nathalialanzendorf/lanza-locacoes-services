...
const dados = {
  ...
  "placa": "MLX-2H34",
  "modeloVeiculo": "HYUNDAI/HB20 1.0",
  "anoModelo": "2013/2014",
  ...
  "qtdDiasLocado": 168,
  "linhaEncerramento": "Encerrado em 25/05/2026 — Devolvido",
  "valorSemanal": 650,
  "valorDiaria": 120,
  "totalDebitos": 970,
  "infracoes": [],
  ...
  "mensagensWhatsApp": [
    ...
    },
    {
      ...
      "titulo": "📋 Despesas em aberto — MLX-2H34",
      "texto": "📋 *Despesas em aberto* — MLX-2H34\n\nOlá, Daniel!\nSegue a listagem das despesas referente à locação do seu HYUNDAI/HB20 1.0 que segue em aberto:\n\n• MLX-2H34 · 01/05/2026 · ATRASADO Troca de Pneu · R$ 320,00\n• RAH-4F54 · 11/07/2026 · ATRASADO Pagamento semanal - Sábado 11 · R$ 650,00\n\n*Total em aberto: R$ 970,00*\n\n_Mensagem automática enviada pelo sistema Gerenciador de Locações Veiculares._\n"
    }
  ],
  "avisos": []
} as {
...
export default function CobrancaMlx2h34DanielDamasceno() {
  const theme = useHostTheme();
