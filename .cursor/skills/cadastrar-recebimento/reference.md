...
Autenticação e execução CLI no site: skill **rastreame-site**.

Documentação auxiliar para a skill **cadastrar-recebimento**. Os exemplos usam **IDs fictícios**; substituir por valores reais obtidos na UI ou em respostas da API. **Não** versionar tokens.
## Endpoints
