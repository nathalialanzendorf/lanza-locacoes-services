...
1. **`RASTREAME_AUTH`** (ou login) definido no ambiente — ver skill **rastreame-site**.
...
5. `npx tsx src/run.ts rastreame-gastos post "relatorios/_gasto_um.json"` — repetir por contrato após preencher `total` e keys.
